...
function showResults(getCapital, getPrice, getShares, varReturn, varProfit, getAlgo, varLooseTaxComm, varNettoReturn, varSuggestion)
{
    ...
    {
        txtUse3 = "</span> EUR. <span class=\"negative\">You loose. GAME OVER! Insert coin.</span></p>";
